...
describe ItemsController do
  ...
  context "new item is created successfully" do
    ...
    it "response redirect" do
      post :create, :item => {name: "a", description: "A", buy_it_now_price: 1, user_id: user.id}
    ...
    it "redirects to items index" do
      post :create, :item => {name: "a", description: "some description", buy_it_now_price: 1, user_id: user.id}

      expect(response).to redirect_to items_path
    end

    it "adds the item to the database" do
      post :create, :item => {name: "ping-pong paddle", description: "you beat Alex with it", buy_it_now_price: 1, user_id: user.id}
